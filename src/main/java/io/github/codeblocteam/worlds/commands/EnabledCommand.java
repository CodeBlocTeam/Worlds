...
public class EnabledCommand implements CommandExecutor {
	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		src.sendMessage(Text.of(TextColors.GREEN, "Propiété Enabled du monde ", TextColors.DARK_GREEN, properties.getWorldName(), TextColors.GREEN, " changée à ", TextColors.DARK_AQUA, state));
